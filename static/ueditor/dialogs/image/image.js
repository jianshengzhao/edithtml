...
(function () {
        ...
        dialog.onok = function () {
            ...
            switch (id) {
                case 'remote'://todo:
                    ...
                    //window.parent.console.log(list);
                    break;
                case 'upload':
            ...
            if(list) {
                editor.execCommand('insertimage', list);//todo:
    ...
    RemoteImage.prototype = {
        ...
        initContainer: function () {//todo:选择图片
            this.dom = {
                'url': $G('url'),
                'width': $G('width'),
                'height': $G('height'),
        ...
        getData: function(){//todo:转换格式
            var data = {};
            // var urls = $('.content-box img'),url=[];          
            // for(var i = 0,len = urls.length; i < len; i++){
            //     url.push(urls.eq(i).attr('src'));
            // }
            // return url;
           // console.log(url);
            ...
            // window.parent.console.log(this);
                ...
                if (val != state) {
                    ...
                    switch (val) {
                        ...
                        case 'ready':
                            ...
                            $queue.removeClass('element-invisible');//todo:
